...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active "><a href="<?php echo base_url() ?>Client_controller/index"
                            class="nav-link">Home</a></li>

                    <li class="nav-item "><a href="<?php echo base_url() ?>Client_controller/aboutus"
                            class="nav-link">About</a></li>

                    <li class="nav-item"><a href="<?php echo base_url() ?>Client_controller/service"
                            class="nav-link">Services</a></li>
                    <li class="nav-item"><a href="<?php echo base_url() ?>Client_controller/doctors"
                            class="nav-link">Doctors</a></li>


                    <?php if (isset($_SESSION['user_id'])) {?>
                    <li class="nav-item"><a href="<?php echo base_url() ?>Client_controller/patientprofile"
                            class="nav-link">My Profile</a></li>

                    <li class="nav-item"><a href="<?php echo base_url() ?>Client_controller/contactus"
                            class="nav-link">Contact</a></li>

                    <li class="nav-item"><a href="<?php echo base_url() ?>Client_controller/logout" class="nav-link">Log
                            Out</a></li>

                    <?php } else {?>
                    <li class="nav-item"><a href="<?php echo base_url() ?>Client_controller/login"
                            class="nav-link">Login</a></li>

                    <?php }?>
                    <li class="nav-item cta"><a href="<?php echo base_url(); ?>Clinic_controller/addappointment"
                            class="nav-link" data-toggle="modal" data-target="#modalRequest"><span>Make an
    ...
    $patient_data = $this->patient_model->patientdata($_SESSION['user_id'])?>
                    ...
                    <form method="post" action="<?php echo base_url() ?>Client_controller/insertappointment"
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="patient_name" class="form-control"
                                            ...
                                            value="<?php echo $patient_data['patient_name'] . ' (' . $patient_data['case_id'] . ')'; ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="email" class="form-control" placeholder="email id"
                                            value="<?php echo $patient_data['email_id']; ?>">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="number" name="age" class="form-control" placeholder="age"
                                            value="<?php echo $patient_data['age']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input name="mobile_no" type="text" placeholder="Mobile No"
                                        ...
                                        value="<?php echo $patient_data['mobile_no']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <textarea name="reason" placeholder="Reason" class="form-control-textarea" cols="30"
                                        rows="7">
			</textarea>
                                </div>
                            </div>
