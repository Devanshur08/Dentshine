	...
	<section class="fxt-template-animation fxt-template-layout6" data-bg-image="<?= LOGIN_PATH?>img/figure/bg-01.jpg">
		...
		<div class="fxt-content">
			<div class="fxt-form">
				...
				<form method="POST" action="<?php echo base_url();?>Client_controller/updatepassword">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="user_password" placeholder="Enter new password" required="required"><br>

						<input type="text" class="form-control" name="user_cpass" placeholder="Enter confirm password" required="required">
					</div>
